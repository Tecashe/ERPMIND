  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-foreground tracking-tight mb-2">Benefits</h1>
        ...
        <div className="card-premium p-12 text-center border border-dashed border-border">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">Benefits features are being built out in the next schema expansion.</p>
        </div>
      </div>
    </DashboardLayout>
  );
